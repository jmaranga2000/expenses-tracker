...
def add_income(request):
    ...
    sources= Source.objects.all()
     # Initialize context with retrieved sources and POST values
    context={
        'sources' : sources,
        'values' : request.POST
    }
    # If request is GET, render add_income template
    if request.method == 'GET':
        
    
        return render(request, 'income/add_income.html',context)
    
# If request is POST, save income record
    if request.method =='POST':
...
# Validate data
    ...
    # Update income object with new data
        ...
        income.save()
# Show success message and redirect to income page
